...
public class View_Consultar_Proveedor extends javax.swing.JFrame {

    /**
     * Creates new form View_Consultar_Proveedor
     */
    public View_Consultar_Proveedor() {
        initComponents();
    ...
    void mostrar(String BuscarDato) {
        ...
        try {
            ...
            modelo = providerController.consult(BuscarDato);
    ...
    private void listadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listadoMouseClicked
        ...
        //ViewProduct.txtcodproveedor.setText(listado.getValueAt(fila, 9).toString());
        ViewPrincipalMenu.txtCodproveedorProducto.setText(listado.getValueAt(fila, 9).toString());

        //ViewProduct.txtProveedor.setText(listado.getValueAt(fila, 2).toString());
        ViewPrincipalMenu.txtProveedorProducto.setText(listado.getValueAt(fila, 2).toString());
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Consultar_Proveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_Consultar_Proveedor().setVisible(true);
            }
        });
    }
