...
public class View_Consultar_Categoria extends javax.swing.JFrame {

    /**
     * Creates new form View_Consultar_Proveedor
     */
    public View_Consultar_Categoria() {
        initComponents();
 ...
 void mostrar(String BuscarDato) {
        ...
        try {
            ...
            modelo = f.consultCategory(BuscarDato);
    ...
    private void initComponents() {
        ...
        jButton1.setText("Ingresar nueva categoria");
    ...
    private void listadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listadoMouseClicked
        ...
        //ViewProduct.txtcodcategoria.setText(listado.getValueAt(fila,0).toString());
        ViewPrincipalMenu.txtCodCategoriaProducto.setText(listado.getValueAt(fila,0).toString());

        //ViewProduct.txtCategoria.setText(listado.getValueAt(fila,1).toString());
        ViewPrincipalMenu.txtCategoriaProducto.setText(listado.getValueAt(fila,1).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nombre = JOptionPane.showInputDialog(this, "Ingrese el nombre de la nueva categoria:", "Nueva Categoria", JOptionPane.INFORMATION_MESSAGE);
        productController.insertCategory(nombre);
        mostrar("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Consultar_Categoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_Consultar_Categoria().setVisible(true);
            }
        });
    }
