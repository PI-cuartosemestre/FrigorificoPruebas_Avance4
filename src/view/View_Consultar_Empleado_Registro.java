...
public class View_Consultar_Empleado_Registro extends javax.swing.JFrame {

    /**
     * Creates new form View_Consultar_Proveedor
     */
    public View_Consultar_Empleado_Registro() {
        initComponents();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(36, 36, 36)
                        .addComponent(txtConsulta, javax.swing.GroupLayout.PREFERRED_SIZE, 598, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void listadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listadoMouseClicked
        ...
        ViewPrincipalMenu.lblCodigoEmpleadoRegistro.setText(listado.getValueAt(fila, 0).toString());
        ViewPrincipalMenu.lblCedulaRegistro.setText("Cédula: "+listado.getValueAt(fila, 1).toString());
        ViewPrincipalMenu.lblNombreRegistro.setText(listado.getValueAt(fila, 3).toString());
        try {
            ViewPrincipalMenu.lblApellidosRegistro.setText(listado.getValueAt(fila, 4).toString());
        } catch (NullPointerException nullE) {
             ViewPrincipalMenu.lblApellidosRegistro.setText("NULL");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Consultar_Empleado_Registro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_Consultar_Empleado_Registro().setVisible(true);
            }
        });
    }
