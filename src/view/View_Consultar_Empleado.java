...
public class View_Consultar_Empleado extends javax.swing.JFrame {

    /**
     * Creates new form View_Consultar_Proveedor
     */
    public View_Consultar_Empleado() {
        initComponents();
    ...
    private void listadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listadoMouseClicked
        ...
        ViewCompras.txtcodempleado.setText(listado.getValueAt(fila, 0).toString());
        ViewCompras.txtnombres.setText(listado.getValueAt(fila, 3).toString());
        try {
            ViewCompras.txtapellidos.setText(listado.getValueAt(fila, 4).toString());
        } catch (NullPointerException nullE) {
            ViewCompras.txtapellidos.setText("NULL");
        }
        try {
            ViewCompras.txttelefono.setText(listado.getValueAt(fila, 6).toString());
        } catch (NullPointerException nullE) {
            ViewCompras.txttelefono.setText("NULL");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Consultar_Empleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_Consultar_Empleado().setVisible(true);
            }
        });
    }
